...
function makeTwelve() {
	...
	fetch(`http://ip-api.com/json/${ipAddress}`)
		...
		.then((data) => {
			// console.log(data);
			let geoPosition = `страна: ${data.country}, регион: ${data.regionName}, город: ${data.city}, широта: ${data.lat}, долгота: ${data.lon}`;
...
function makeFourteen() {
	fetch('https://official-joke-api.appspot.com/random_joke')
		...
		.then((data) => {
			...
			result.textContent = `${data.setup}, ${data.punchline}`
		})
